...
* **Equatorial Biome**: Tropical rainforests — high temperature, heavy rainfall, greatest biodiversity (Amazon, Congo, Southeast Asia).
...
::: {.callout-tip}
### UGC NET Classification (Ecosystem-based)
