...
* **Human Development Index (HDI)**: Created by **Dr. Mahbub ul Haq** and Amartya Sen for the UNDP (1990). HDI ranges from **0 to 1**. Measures:
...
* **Four Pillars of Human Development**: **Equity** (equal access), **Sustainability** (for future generations), **Productivity** (investment in people), **Empowerment** (freedom to participate).
