...
|----------|---------------|
| **NEP-2020** | Unit I — Concepts, Types of models (Conceptual, Mathematical, Physical), Spatial simulation |
| **UGC NET** | Unit X — Geospatial analysis, spatial statistics, and modelling |
:::

[![](https://via.placeholder.com/600x300?text=Spatial+Modelling+Overview)](#)
