...
Formed from the cooling and solidification of magma/lava.
- **Intrusive (Plutonic):** Solidified deep inside (Granite).
- **Extrusive (Volcanic):** Solidified on the surface (Basalt).
- **Classification:** 
  - **Felsic:** High Feldspar/Silica.
  - **Mafic:** High Iron/Magnesium.
...
- **Argillaceous:** Clay-based (Shale).
- **Arenaceous:** Sand-based (Sandstone).
