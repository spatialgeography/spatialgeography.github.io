---
title: 03-machine-learning-in-gis
id: 20260430146010
---
...
|----------|---------------|
| **NEP-2020** | Unit III — Supervised vs Unsupervised learning, Algorithms (Random Forest, SVM, K-means) |
| **UGC NET** | Unit X — Statistical techniques and automated mapping |
:::

[![](https://via.placeholder.com/600x300?text=Machine+Learning+in+GIS)](#)
...
* **Machine Learning (ML)**: Algorithms that learn from data and make predictions. Unlike traditional GIS queries, ML "learns" patterns directly from the training data.
