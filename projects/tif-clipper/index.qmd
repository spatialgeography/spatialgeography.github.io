...
## 🌍 TIF Viewer & Clipper App

**[🚀 Launch Live App](https://55xsd7-spatial-geography.shinyapps.io/tif_clipper/){.btn .btn-primary}**
...
## 🖥️ Try it Now (Embedded)

<iframe src="https://55xsd7-spatial-geography.shinyapps.io/tif_clipper/" width="100%" height="800px" style="border:1px solid #ccc; border-radius:8px;"></iframe>

---

## 💻 Source Code

You can also run this app locally using RStudio. Ensure you have the required packages installed: `shiny`, `terra`, `sf`, `leaflet`.
...
### 📥 Download
[Download app.R](../../shiny_apps/tif_clipper/app.R)
